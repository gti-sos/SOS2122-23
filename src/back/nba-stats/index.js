module.exports.register = (app) => {
    ...
    var nbaStats = [
        ...
        app.get(BASE_API_URL, (req,res)=>{ 
            ...
            if(query.name){
                dbquery['name'] = parseFloat(query.name);
            }
            if(query.mostpoints){
                dbquery['mostpoints'] = parseFloat(query.mostpoints);
            }
            if(query.fieldgoals){
                dbquery['fieldgoals'] = parseFloat(query.fieldgoals);
            }
            if(query.efficiency){
                dbquery['efficiency'] = parseFloat(query.efficiency);
            }
